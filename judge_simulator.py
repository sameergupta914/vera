...
3. Set your bot URL below if needed
4. Run: `py -3.11 judge_simulator.py`
...
# Your API key is loaded from .env / environment variables
LLM_API_KEY = ""
...
LLM_API_KEY = os.getenv("OPENAI_API_KEY", LLM_API_KEY)
